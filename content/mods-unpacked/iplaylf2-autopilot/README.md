...
规划器反复比较停留与各个移动方向，综合生存压力、资源、自动攻击机会、移动机制和全局导航价值，
每次只提交下一个短周期的移动输入。

敌对危险、友方减压和治疗机会保持不同语义：友方火力只能抵消对应的环境压力，投射物拦截只能抵消
已拦下的弹道压力，治疗则作为独立收益。这些约束避免将支援能力误解为无条件的安全区。具体观察字段、
...
计划包含所选动作、移动方向、结果字段、逐项效用、动态上下文、导航价值图、搜索预算和近优动作摘要，
供游戏内诊断与回放校准。
