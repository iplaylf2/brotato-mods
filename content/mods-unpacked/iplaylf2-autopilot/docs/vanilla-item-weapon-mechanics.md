...
| 命中后二次武器效果 | 爆炸武器、燃烧武器、Cactus Mace、Lightning Shiv、Sniper Gun、Vorpal Sword | 统一描述爆炸、燃烧、派生投射物和斩杀概率，并计入每个保留候选的预期伤害 |
...
目标版本的原版字段、内容名称和原版资源类型只允许出现在 `bot/knowledge` 版本知识边界。
